...
public class MeteorContextHandlerTest {
	/**
	...
	public void setUp() throws Exception {
		...
		when( configMock.getInteger( MeteorConfigConstants.WEB_FRONTEND_PORT_KEY,
				MeteorConfigConstants.DEFAULT_WEB_FRONTEND_PORT ) ).thenReturn( VIS_PORT );
	...
	public void getResourceByGivenPathTest(){
		...
		verify( configMock, times(0) ).getString(MeteorConfigConstants.STRATOSPHERE_BASE_DIR_PATH_KEY, "");
		verify( configMock, times(0) ).getString(MeteorConfigConstants.WEB_ROOT_PATH_KEY,
	...
	public void getResourceDoesNotExistTest() {
		...
		when( configMock.getString( MeteorConfigConstants.STRATOSPHERE_BASE_DIR_PATH_KEY, "") )
		...
		try {
			...
			// verify interactions
			verify( configMock, times(1) ).getString(WebFrontend.RESOURCEDIR, null);
			verify( configMock, times(1) ).getString(MeteorConfigConstants.STRATOSPHERE_BASE_DIR_PATH_KEY, "");
		}
	}
